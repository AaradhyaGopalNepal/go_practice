...
func (x *HelloRequets) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloRequets) ProtoMessage() {}

func (x *HelloRequets) ProtoReflect() protoreflect.Message {
	mi := &file_greeter_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use HelloRequets.ProtoReflect.Descriptor instead.
func (*HelloRequets) Descriptor() ([]byte, []int) {
	return file_greeter_proto_rawDescGZIP(), []int{0}
}

func (x *HelloRequets) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
const file_greeter_proto_rawDesc = "" +
	...
	"\rgreeter.proto\x12\n" +
	"calculator\"\"\n" +
	"\fHelloRequets\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"#\n" +
	"\rHelloResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\x15Z\x13/proto/gen;mainpipbb\x06proto3"
...
var file_greeter_proto_goTypes = []any{
	(*HelloRequets)(nil),  // 0: calculator.HelloRequets
