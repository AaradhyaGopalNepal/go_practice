...
type GreeterClient interface {
	Greet(ctx context.Context, in *HelloRequets, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *greeterClient) Greet(ctx context.Context, in *HelloRequets, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GreeterServer interface {
	Greet(context.Context, *HelloRequets) (*HelloResponse, error)
...
func (UnimplementedGreeterServer) Greet(context.Context, *HelloRequets) (*HelloResponse, error) {
...
func _Greeter_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Greet(ctx, req.(*HelloRequets))
	}
	return interceptor(ctx, in, info, handler)
}
